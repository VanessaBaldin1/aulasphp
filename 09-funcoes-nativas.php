...
<head>
  ...
  <title>PHP - Funções Nativa</title>
...
$ataqueSanitizado = filter_var($ataqueDeRaqui, FILTER_SANITIZE_FULL_SPECIAL_CHARS);
...
?>
  ...
  <hr>
  <p class="alert alert-success">Métodos/Algoritmos antigos ideal atualmente</p>
